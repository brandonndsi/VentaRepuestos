...
<html lang="es">
    ...
    <center>
        <h1>
            Empleados
            <button onclick="verRegistrarEmpleado();" class="btn btn-primary">Nuevo Empleado</button>
        </h1> 
    </center>
    <div class="col-md-12">
    ...
    <!-- Modal -->
    <div class="modal" id="modalRegistrarEmpleado" role="dialog">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="modalRegistrarEmpleado">Registrar</h5>
                    <button type="button" class="close" onclick="cerrarModalRegistrar()">
                ...
                <div class="modal-body">
                    <form>
                        ...
                        <div style="width:50%; float:left;">
                            ...
                            <p class="col-sm-8">Fecha de Ingreso:<input type="date" name="empleadofechadeingreso" class="form-control" id="empleadofechadeingreso" step="1" min="2017-01-01" max="2050-12-31" required/></p>
                        </div> 
                    </form>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-danger" onclick="cerrarModalRegistrar()">Cancelar</button>
                    <button  onclick="RegistrarEmpleado();" class="btn btn-success" >Registrar</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <!-- Modal -->
    <div class="modal" id="modalModEmpleado" role="dialog">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="form-control">
                        ...
                        <div>
                            <p class="col-sm-8">ID: <input type="text" name="empleadoid2" class="form-control" id="empleadoid2" readonly/></p>
                            <p class="col-sm-8">Nombre: <input type="text" name="empleadonombre2" class="form-control" id="empleadonombre2" readonly/></p>
                        </div>    
                    </form>
                </div>
                <div class="modal-footer">
    ...
    <!-- Modal -->
    <div class="modal" id="modalVerMasEmpleado" role="dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="form-control">
                        ...
                        <p class="col-sm-8">Edad: <input type="text" name="empleadoedad" class="form-control" id="empleadoedad" readonly/></p>
                        <p class="col-sm-8">Sexo: <input type="text" name="empleadosexo" class="form-control" id="empleadosexo" readonly/></p>
                        <p class="col-sm-8">Estado Civil: <input type="text" name="empleadoestadocivil" class="form-control" id="empleadoestadocivil" readonly/></p>
                        <p class="col-sm-8">Banco: <input type="text" name="empleadobanco" class="form-control" id="empleadobanco" readonly/></p>
                    </form>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-success" onclick="cerrarModalBuscar()">Salir</button>
                </div>
            </div>
        </div>
    </div>
