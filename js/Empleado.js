...
function RegistrarEmpleado() {
    nombre = $("#personanomb").val();
    apellido1 = $("#personaapelli1").val();
    apellido2 = $("#personaapelli2").val();
    cedula = $("#empleadocedu").val();
    telefono = $("#personatel").val();
    correo = $("#personaemail").val();
    tipoEmpleado = $("#combotipoemple").val();
    clave = $("#empleadocontrasena").val();
    edad = $("#empleadoage").val();
    sexo = $("#combosexo").val();
    estadoCivil = $("#comboestadocivil").val();
    banco = $("#combobanco").val();
    cuenta = $("#empleadocuentabanco").val();
    fechaIngreso = $("#empleadofechadeingreso").val();
